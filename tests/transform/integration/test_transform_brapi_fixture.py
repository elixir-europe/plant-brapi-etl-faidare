...
class TestTransformBrAPIFixture(unittest.TestCase):
    ...
    def test_all_germplasms_generated(self):
        ...
        with open(self._expected_data_dir+"expected/VIB_germplasm_expected.json") as expected_vib_f:
    ...
    def test_all_datadiscovery_generated(self):
        ...
        with open(self._expected_data_dir+"expected/VIB_datadiscovery_expected.json") as expected_vib_f:
            expected_vib = json.load(expected_vib_f)
    ...
    def test_all_locations_generated(self):
        ...
        with open(self._expected_data_dir+"expected/VIB_location_expected.json") as expected_vib_f:
            expected_vib = json.load(expected_vib_f)
    ...
    def test_all_observationVariables_generated(self):
        ...
        with open(self._expected_data_dir+"expected/VIB_observation_variable_expected.json") as expected_vib_f:
            expected_vib = json.load(expected_vib_f)
    ...
    def test_all_studys_generated(self):
        ...
        with open(self._expected_data_dir+"expected/VIB_study_expected.json") as expected_vib_f:
            expected_vib = json.load(expected_vib_f)
    ...
    def test_all_trials_generated(self):
        ...
        with open(self._expected_data_dir+"expected/VIB_trial_expected.json") as expected_vib_f:
            expected_vib = json.load(expected_vib_f)
    ...
    def test_all_contacts_generated(self):
        ...
        with open(self._expected_data_dir+"expected/VIB_contact_expected.json") as expected_vib_f:
            expected_vib = json.load(expected_vib_f)
